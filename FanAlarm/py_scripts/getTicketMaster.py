...
for state in statecodes:
    for i in range(1,5):
        res = requests.get(
            "https://app.ticketmaster.com/discovery/v2/events.json?classificationName=music&page="+str(i)+"&countryCode=CA&size=200&city=toronto&stateCode="+str(state)+"&apikey=nbURA89kvA7ccZts3NF8sYPtKZhpGzY0")
        list = res.json()
        print(list)
        newList = []
